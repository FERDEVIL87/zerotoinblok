...
const items = document.querySelectorAll(".songlistwrap,.feature-content,.logo,.container,.song-list-title,.navbar-container,.sidebar,.left-menu-icon,.toggle,.songlistimg,.songlistitem,.songlistdesc,.videotitle,.videodesc,.videodet,.videocontent");
